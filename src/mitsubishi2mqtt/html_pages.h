...
"<h3>_TXT_CTRL_LOCAL_OR_REMOTE_ _TXT_F_LOCAL_OR_REMOTE_ </h3>"
"<div id='l1' name='l1'>"
    "<fieldset>"
...
"<div id='l1' name='l1'>"
    "<fieldset>"
        ...
        "<form method='post'>"
            ...
            "</p>"
            "<p>"
                "<b>_TXT_UNIT_ALLOW_EXTERNAL_UPDATE_</b>"
                "<select name='eu'>"
                    "<option value='OFF' _EXTERNAL_UPDATE_OFF_>_TXT_F_OFF_</option>"
                    "<option value='ON' _EXTERNAL_UPDATE_ON_>_TXT_F_ON_</option>"
                "</select>"
            "</p>"
